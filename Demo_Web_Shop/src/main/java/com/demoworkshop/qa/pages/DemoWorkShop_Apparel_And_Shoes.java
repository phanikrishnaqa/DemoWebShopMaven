...
public class DemoWorkShop_Apparel_And_Shoes extends TestBase{
	
	public static final Logger log = Logger.getLogger(DemoWorkShop_Apparel_And_Shoes.class.getName());
		...
		@FindBy(xpath ="//a[contains(text(),\"50's Rockabilly Polka Dot Top JR Plus Size\")]") //e6
	...
	public DemoWorkShop_Apparel_And_Shoes() {
	...
	public void Click_Apparel_And_Shoes_Link(String strApparelAndShoesExp) {
		...
		if(strApparelAndShoesExp.equalsIgnoreCase(strApparelAndShoesAct)){
			log("Jewelry page is displayed with expected :" + strApparelAndShoesExp + " is matched with Actual value : " + strApparelAndShoesAct);
		}else {
			log("Jewelry page is not displayed with expected :" + strApparelAndShoesExp + " is not matched with Actual value : " + strApparelAndShoesAct);
		}	
		System.out.println("***************************************************");		
	}
